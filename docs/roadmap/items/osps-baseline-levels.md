...
<b>Level 2's last criterion was a DCO</b>, and the interesting part was what it could
<i>not</i> be. A <code>Signed-off-by</code> is the contributor asserting they may submit the
work, so backfilling one onto 569 existing commits under a reviewer's name would certify
nothing — while rewriting <code>main</code>, breaking 478 tags and invalidating the
