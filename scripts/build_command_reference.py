...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Site footer — same content as every other docs page. This page is
     self-contained (its sidebar layout owns .wrap), so the rules are local. */
  footer { border-top: 1px solid var(--line); padding: 30px 20px 40px; text-align: center; }
  footer .foot-brand { font-size: 14.5px; color: var(--text-2); }
  footer .foot-brand b { font-family: var(--mono); font-weight: 700; color: var(--amber); }
  footer .foot-note { margin-top: 9px; font-size: 13px; color: var(--text-2); opacity: .8; }
  footer .foot-note code { font-size: .92em; color: var(--amber);
    background: rgba(34,211,238,.08); border: 1px solid var(--line);
    border-radius: 6px; padding: 2px 8px; }
  footer .foot-links { display: flex; flex-wrap: wrap; justify-content: center;
    gap: 4px 6px; margin-top: 16px; }
  footer .foot-links a { display: flex; align-items: center; min-height: 40px;
    padding: 5px 11px; border-radius: 8px; font-size: 13px;
    color: var(--text-2); text-decoration: none; }
  footer .foot-links a:hover,
  footer .foot-links a[aria-current="page"] { color: var(--text); background: var(--panel); }
  footer .foot-legal { margin-top: 13px; font-size: 12.5px; color: var(--text-2); opacity: .75; }
  footer .foot-legal a { color: var(--text-2); text-decoration: underline; }
</style>
</head>
<body>
<div class="wrap">
